from PySimpleGUI import Window, Input, WIN_CLOSED, Column, Button, Text, theme, Image
...
weather_column = Column([
    [Image('', key='-IMAGE-', background_color='#FFFFFF', )]],
    key='-LEFT-',
    background_color='#FFFFFF')

info_column = Column([
    [Text('', key='-LOCATION-', font='Calibri 30', background_color='#FF0000', pad=0, visible=False)],
    [Text('', key='-TIME-', font='Calibri 16', background_color='#000000', text_color='#FFFFFF', pad=0,
          visible=False)],
    [Text('', key='-TEMP-', font='Calibri 16', pad=(0, 10), background_color='#FFFFFF', text_color='#000000',
          justification='center', visible=False)]
], key='-RIGHT-',
    background_color='#FFFFFF')

main_layout = [
    [Input(key='-INPUT-', expand_x=True), Button('submit', button_color='#000000')],
    [weather_column, info_column]
]

theme('reddit')
window = Window('Weather', main_layout)
