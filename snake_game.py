...
while True:
    ...
    if event in ['Left:37', 'Left:113']: direction = DIRECTIONS['left']
    if event in ['Up:38', 'Up:111']: direction = DIRECTIONS['up']
    if event in ['Right:39', 'Right:114']: direction = DIRECTIONS['right']
    if event in ['Down:40', 'Down:116']: direction = DIRECTIONS['down']
